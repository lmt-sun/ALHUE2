...
class SMOTEBoost(AdaBoostClassifier):
    ...
    def __init__(self,
        ...
        self.smote = SMOTE2(k_neighbors=k_neighbors,
...
import pandas as pd
from imblearn.over_sampling import SMOTE as SMOTE_IMB, SMOTE
from sklearn.tree import DecisionTreeClassifier as DT, DecisionTreeClassifier
